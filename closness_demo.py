...
num = 6 # See "sets" variable
cen_num = 1 #0:closeness, 1:degree, 2:eigenvector
...
sets = ['4',        #0
        ...
        '16_30_18', #6
        '10']       #7
frames= [[0,60],[47,80],[55,95], [52,98],[14,50], [59,85], [65,72]]
...
agent_idx = list(obj_IDs).index(agent_ID[0]) if num==2 else list(obj_IDs).index(agent_ID)
